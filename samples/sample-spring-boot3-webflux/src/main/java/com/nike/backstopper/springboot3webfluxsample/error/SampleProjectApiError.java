...
public enum SampleProjectApiError implements ApiError {
    ...
    ERROR_THROWN_IN_WEB_FILTER(99150, "An error was thrown in a WebFilter", HttpStatus.INTERNAL_SERVER_ERROR.value()),
    ERROR_RETURNED_IN_WEB_FILTER_MONO(99151, "An error was returned in a WebFilter Mono", HttpStatus.INTERNAL_SERVER_ERROR.value()),
    ERROR_THROWN_IN_HANDLER_FILTER_FUNCTION(99155, "An error was thrown in a HandlerFilterFunction", HttpStatus.INTERNAL_SERVER_ERROR.value()),
    ERROR_RETURNED_IN_HANDLER_FILTER_FUNCTION_MONO(99156, "An error was returned in a HandlerFilterFunction Mono", HttpStatus.INTERNAL_SERVER_ERROR.value()),
    WEBFLUX_MONO_ERROR(99160, "You hit the WebFlux Mono error endpoint", HttpStatus.INTERNAL_SERVER_ERROR.value()),
    WEBFLUX_FLUX_ERROR(99170, "You hit the WebFlux Flux error endpoint", HttpStatus.INTERNAL_SERVER_ERROR.value());
