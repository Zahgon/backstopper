...
public abstract class ApiExceptionHandlerBase<T> {
     ...
     */
    public ApiExceptionHandlerBase(ProjectApiErrors projectApiErrors, List<ApiExceptionHandlerListener> apiExceptionHandlerListenerList, ApiExceptionHandlerUtils utils) {
     ...
     */
    public final Set<String> DEFAULT_WRAPPER_EXCEPTION_CLASS_NAMES = new HashSet<>(Arrays.asList(WrapperException.class.getName(), ExecutionException.class.getName(), "java.util.concurrent.CompletionException"));
     ...
     */
    public ErrorResponseInfo<T> maybeHandleException(Throwable ex, RequestInfoForLogging request) throws UnexpectedMajorExceptionHandlingError {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @param request The incoming request.
     */
    protected ErrorResponseInfo<T> doHandleApiException(SortedApiErrorSet clientErrors, List<Pair<String, String>> extraDetailsForLogging, List<Pair<String, List<String>>> extraResponseHeaders, Throwable originalException, RequestInfoForLogging request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    protected boolean shouldLogStackTrace(int statusCode, @SuppressWarnings("unused") Collection<ApiError> filteredClientErrors, @SuppressWarnings("unused") Throwable originalException, Throwable coreException, @SuppressWarnings("unused") RequestInfoForLogging request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
