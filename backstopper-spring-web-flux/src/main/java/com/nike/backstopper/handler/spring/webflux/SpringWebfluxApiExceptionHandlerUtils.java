...
public class SpringWebfluxApiExceptionHandlerUtils {
     ...
     */
    public static final SpringWebfluxApiExceptionHandlerUtils DEFAULT_IMPL = new SpringWebfluxApiExceptionHandlerUtils();
     ...
     */
    public Mono<ServerResponse> generateServerResponseForError(DefaultErrorContractDTO errorContractDTO, int httpStatusCode, Collection<ApiError> rawFilteredApiErrors, Throwable originalException, RequestInfoForLogging request) {
    ...
    protected MediaType getErrorResponseContentType(DefaultErrorContractDTO errorContractDTO, int httpStatusCode, Collection<ApiError> rawFilteredApiErrors, Throwable originalException, RequestInfoForLogging request) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
